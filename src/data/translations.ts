...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    presentationSection: {
      ...
      awardTitle: 'Excellence Logistique Directe',
      awardDesc: 'Plus de 15 ans d\'expertise exclusive entre la Chine et la République Démocratique du Congo sans intermédiaire.',
      title: 'Votre pont direct et exclusif entre la Chine et la RDC.',
      desc: 'CM SERVICE CO., LIMITED est une société internationale de logistique, d\'ingénierie d\'achat et de facilitation douanière. Nous sommes physiquement et exclusivement implantés dans deux pays : en Chine (hub de Guangzhou) et en République Démocratique du Congo (siège à Kinshasa).',
    ...
    footer: {
      about: 'CM SERVICE CO., LIMITED est votre partenaire de confiance exclusif pour le sourcing usines, le transit maritime, le fret aérien et l\'achat de véhicules chinois vers la RDC.',
  ...
  zh: {
    ...
    presentationSection: {
      ...
      title: '连接中国市场与刚果（金）的直营信赖桥梁',
      desc: 'CM SERVICE CO., LIMITED 是一家专业国际物流、采购工程和海关通关服务公司。我们在中国（广州中心）和刚果（金）（金沙萨总部）仅设两地专属直营办事处，全程自主把控，无任何第三方中介。',
    ...
    footer: {
      about: 'CM SERVICE CO., LIMITED 是您在采购、海运、空运及中国品牌汽车出口刚果（金）方面值得信赖的直营合作伙伴。',
      quickLinks: '快速导航',
      ourServices: '我们的服务',
      contactUs: '联系我们',
  ...
  en: {
    ...
    hero: {
      ...
      tagline: 'Direct permanent offices in China (Guangzhou) & DRC (Kinshasa) only',
    },
    servicesSection: {
    ...
    statsBanner: {
      ...
      offices: 'Permanent Offices (Guangzhou & Kinshasa only)',
      shipments: 'Successful Shipments China ➔ DRC',
      guarantee: 'Safety & Customs Clearance Guarantee',
    },
    presentationSection: {
      badge: 'ABOUT OUR GROUP',
      subBadge: 'EXCLUSIVE BILATERAL PRESENCE',
      officeTitle: 'Direct Offices in China & DRC Only',
      awardTitle: 'Direct Logistics Excellence',
      awardDesc: 'Over 15 years of dedicated expertise connecting China and DRC without third-party intermediaries.',
      title: 'Your Direct, Trusted Bridge Between China & DRC.',
      desc: 'CM SERVICE CO., LIMITED is an international logistics, purchasing engineering, and customs facilitation company operating exclusively in two countries: China (Guangzhou trade hub) and the Democratic Republic of Congo (Kinshasa headquarter).',
    ...
    footer: {
      about: 'CM SERVICE CO., LIMITED is your direct trusted partner for factory sourcing, sea freight, air cargo, and Chinese vehicles to the DRC.',
